...
## 2. Problem Descriptions and Objectives (Draft)
...
```{r, echo=FALSE, warning=FALSE,width=10,fig.height=11}
...
After exploring and analyzing the Apple App Store dataset that contains over 7,000 apps, we have discovered what variables affect an app's success (determined by its total rating count) the most. The most impactful variables are if the app is free or not and the total download size of the app. 
