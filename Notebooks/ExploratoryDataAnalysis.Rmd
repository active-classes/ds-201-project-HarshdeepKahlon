...
```
From the boxplot above, we can see a clear growth in total ratings (which gives a rough indication of total downloads) until the user ratings goes above 2 stars. However, from 2 - 5 stars, the difference in rating count cannot be determined from the graph.